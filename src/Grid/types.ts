...
type ContainerProps<ContainerType> = React.DetailedHTMLProps<
  React.HTMLAttributes<ContainerType>,
  ContainerType
>;
...
export type GridContainerProps<ContainerType = HTMLDivElement> =
...
export type GridItemProps<ContainerType = HTMLDivElement> =
  ContainerProps<ContainerType> &
    GridColumnStartCSS &
    GridColumnEndCSS &
    GridRowStartCSS &
